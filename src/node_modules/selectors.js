...
export const getBasketProductsWithCount = state => {
    ...
    const productSubPrice = product =>  {return product.price * product.count;};
    const productWithSubPrice = product => R.assoc('subPrice', productSubPrice(product), product)


    const uniqueIds = R.uniq(state.basket)
    const products = R.compose(
        R.map(productWithSubPrice),
